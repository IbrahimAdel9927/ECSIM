...
class Resistor_Class:
    ...
    def view_current(self,event):
        ...
        w,v=self.right
        self.label1.place(x=w-60,y=v-45)
    ...
    def view_power(self, event):
        ...
        w,v=self.right
        self.label1.place(x=w-60,y=v+15)
...
class DC_Power_Class:
    ...
    def change_value(self):
        new_value = simpledialog.askstring("Voltage value" , "please enter the new value", initialvalue=self.value)
        if new_value:
            self.value = new_value
...
root.iconbitmap("D:\\downloads\\testlib-master\\project\\project.ico")
